...
It reads `task.md` and creates planning artifacts at the paths recorded there.

## Responsibilities

- Create `plan.md` when the user wants an Obsidian task-folder plan.
...
- Update `task.md` status/path/log fields after planning.
...
plan-intake-automation: task.md -> plan.md / Cursor plan / discussion docs
...
- **Plan file:** `Projects/my-project/20260525-add-export-button/plan.md`
...
```text
Projects/my-project/20260525-add-export-button/plan.md
```
...
Keep executable todos in `plan.md` or the Cursor plan frontmatter, not in discussion docs.
